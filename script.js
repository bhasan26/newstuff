...
function revealOnScroll() {
    const elements = document.querySelectorAll('.project-card, .timeline-item, .stat');
...
style.textContent = `
    .project-card, .timeline-item, .stat {
        opacity: 0;
        transform: translateY(30px);
        transition: all 0.6s ease;
    }
    
    .project-card.animate, .timeline-item.animate, .stat.animate {
        opacity: 1;
